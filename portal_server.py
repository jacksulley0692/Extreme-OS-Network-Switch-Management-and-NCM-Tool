...
<body class="bg-slate-950 text-slate-100 p-8 font-sans">
  <div class="max-w-xl mx-auto bg-slate-900 border border-slate-800 p-6 rounded-xl shadow-xl">
    ...
    <div class="bg-slate-950 p-3 rounded text-xs font-mono text-emerald-400">
      Checked paths:<br/>
      • /opt/switch-backup/Extreme-OS-Network-Switch-Management-and-NCM-Tool/portal_index.html
    </div>
  </div>
</body>
</html>"""
