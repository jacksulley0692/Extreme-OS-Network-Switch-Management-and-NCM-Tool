...
export const SitePageView: React.FC<SitePageViewProps> = ({
  ...
  return (
    <div className="space-y-6" id={`site-page-${siteCode.toLowerCase()}`}>
      {/* Site Header Banner */}
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                <h3 className="text-sm font-bold text-white">
                  {displayName} Physical &amp; Logical Topology Diagram
                </h3>
                {isYorkSite ? (
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                Core Extreme switches, VOSS fabric links, firewall uplinks, and IDF distribution layouts.
              </p>
            </div>
          </div>
      ...
      {/* Site Switches Fleet Inventory Section */}
